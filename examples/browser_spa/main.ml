...
let get_element id = Dom_html.getElementById id
let set_html el html = el##.innerHTML := Js.string html
...
let setup_navigation () =
  ...
  let handler =
    Dom_html.handler (fun event ->
      ...
      Js._true)
  in
  Dom_html.addEventListener Dom_html.document Dom_html.Event.click handler Js._false
  |> ignore
;;
