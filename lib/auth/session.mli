...
val get_id_from_request :
  ?cookie_name:string -> Kirin.Request.t -> string option
val set_session_cookie :
  ...
  ?max_age:int -> string -> Kirin.Response.t -> Kirin.Response.t
val clear_session_cookie :
  ?cookie_name:string ->
  ?path:string -> Kirin.Response.t -> Kirin.Response.t
val middleware :
  ?cookie_name:string ->
