...
val generate_action_type :
  name:string -> input_type:string -> return_type:string -> string
val generate_component :
  name:string -> props:(string * string) list -> string
...
val generate_qrl :
  chunk:string -> symbol:string -> capture:string list -> string
