...
val on
  :  element
  -> string
  -> ('a #Js_of_ocaml.Dom.event Js_of_ocaml__.Js.t -> unit)
  -> unit

val on_click : element -> ('a #Js_of_ocaml.Dom.event Js_of_ocaml__.Js.t -> unit) -> unit
val on_input : element -> ('a #Js_of_ocaml.Dom.event Js_of_ocaml__.Js.t -> unit) -> unit
val on_submit : element -> ('a #Js_of_ocaml.Dom.event Js_of_ocaml__.Js.t -> unit) -> unit
...
val get_storage : unit -> Js_of_ocaml.Dom_html.storage Js_of_ocaml__.Js.t option
...
module Router : sig
  ...
  val create : not_found:((string * string) list -> unit) -> route_pattern list -> t
  val match_path : string list -> string list -> (string * string) list option
