...
val param :
  string -> 'a Route_def.action_context -> string option
val json_body :
  'a Route_def.action_context -> Yojson.Safe.t option
val field :
  string ->
  'a Route_def.action_context -> Yojson.Safe.t option
val string_field :
  string -> 'a Route_def.action_context -> string option
val int_field :
  string -> 'a Route_def.action_context -> int option
val bool_field :
  string -> 'a Route_def.action_context -> bool option
...
val validate_field :
  ...
  'a Route_def.action_context -> (string * string) list
val validate :
...
val chain :
  ('a -> 'b action_result) ->
  ('a -> 'b action_result) -> 'a -> 'b action_result
val with_validation :
  (string * validation_rule list) list ->
