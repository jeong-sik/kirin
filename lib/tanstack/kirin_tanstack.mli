...
val register
  :  route_id:string
  -> ?loader:('a Route_def.loader_context -> (Yojson.Safe.t, string) result)
  -> ?action:('a Route_def.action_context -> (Yojson.Safe.t, string) result)
  -> 'a Handler.registry
  -> unit
...
val setup
  :  routes_dir:string
  -> ctx_factory:'a
  -> Manifest.t * 'b Handler.registry * Handler.config * 'a
