...
val ok : ?headers:(string * string) list -> ?status:int -> 'a -> 'a loader_result
val param : string -> 'a Route_def.loader_context -> string option
val param_exn : string -> 'a Route_def.loader_context -> string
val param_int : string -> 'a Route_def.loader_context -> int option
val search_param : string -> 'a Route_def.loader_context -> string option
val search_params_all : string -> 'a Route_def.loader_context -> string list
...
type ('ctx, 'a, 'b) middleware =
  ('ctx, 'a) Route_def.loader -> ('ctx, 'b) Route_def.loader
