...
val shadow : ?mode:Shadow_dom.shadow_mode -> ?styles:string list -> string -> Shadow_dom.t
...
val when_ : string -> then_:Template.t -> ?else_:Template.t -> unit -> Template.t
val repeat : items:string -> item:string -> ?index:string -> Template.t -> Template.t
val to_html : Template.t -> string
val render_static : data:(string * Yojson.Safe.t) list -> Template.t -> string
...
val ssr
  ...
  -> ?slots:(string option * string) list
  -> unit
  -> (string, 'a) result
