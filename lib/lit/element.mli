type property_type = String | Number | Boolean | Object | Array
type property = {
  prop_name : string;
...
val string_prop :
  ?attribute:bool ->
  ?reflect:bool -> ?default:string option -> string -> property
val number_prop :
  ?attribute:bool ->
  ?reflect:bool -> ?default:float option -> string -> property
val boolean_prop :
  ?attribute:bool ->
  ?reflect:bool -> ?default:bool option -> string -> property
...
val create :
  ...
  class_name:string ->
  ?properties:property list ->
  ?styles:string list -> ?shadow_mode:[ `Closed | `Open ] -> string -> t
