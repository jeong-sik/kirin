val url :
  ?base_url:string -> manifest:Manifest.t -> string -> string
val script_tag :
  ?base_url:string ->
  ?module_:bool -> manifest:Manifest.t -> string -> string
val link_tag :
  ?base_url:string -> manifest:Manifest.t -> string -> string
val css_tags :
  ?base_url:string -> manifest:Manifest.t -> string -> string
...
val preload_tag :
  ?base_url:string -> ?crossorigin:bool -> as_type:string -> string -> string
...
val body_tags :
  ?base_url:string ->
  manifest:Manifest.t -> entry:string -> unit -> string
type config = { base_url : string; manifest : Manifest.t; }
