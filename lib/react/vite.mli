...
val static_handler :
  config:prod_config -> manifest:'a -> Kirin.Request.t -> Kirin.Response.t
val static_routes : ?config:prod_config -> unit -> Kirin.Router.route list
val routes :
  ?dev_config:dev_config ->
  ?prod_config:prod_config -> unit -> Kirin.Router.route list
