...
val html_start : title:string -> head_extra:string -> styles:string list -> string
val html_end : scripts:string list -> initial_data:Yojson.Safe.t option -> string
