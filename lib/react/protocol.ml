...
let render_request ~id ~url ?(props = `Assoc []) () =
  { id; method_ = "render"; params = `Assoc [ "url", `String url; "props", props ] }
;;

(** Create streaming render request *)
let stream_request ~id ~url ?(props = `Assoc []) () =
  { id; method_ = "stream"; params = `Assoc [ "url", `String url; "props", props ] }
;;

(** Create health check request *)
let health_request ~id = { id; method_ = "health"; params = `Assoc [] }

(** Create shutdown request *)
let shutdown_request ~id = { id; method_ = "shutdown"; params = `Assoc [] }
