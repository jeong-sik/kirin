...
val compress : ?min_size:int -> (Request.t -> Response.t) -> Request.t -> Response.t
...
val ws_close : ?code:Websocket.close_code -> ?reason:string -> unit -> Websocket.frame
...
val stream_file_inline : ?content_type:string -> ?chunk_size:int -> string -> Response.t
...
val template_context : ('a * 'b) list -> [> `Assoc of ('a * [> `String of 'b ]) list ]
...
val tls_config
  ...
  -> ?alpn:string list
  -> unit
  -> Tls_config.t Tls_config.result
