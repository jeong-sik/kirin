...
val render_islands :
  'a -> Island.t list -> (string * string) list
val generate_static :
  t -> url:string -> output_path:string -> unit -> (string, string) result
val generate_all_static :
  t ->
  Route_def.t list -> string -> (string, string) result list
