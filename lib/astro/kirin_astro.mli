...
val hybrid_config : dist_path:string -> ?workers:int -> unit -> Handler.config
...
val define_schema : string -> (string * Content.schema_field) list -> Content.schema
val define_collection : name:string -> schema:Content.schema -> Content.collection
...
val enable_view_transitions : View_transitions.config -> View_transitions.config
...
val transition_element
  ...
  -> ?persist:bool
  -> unit
  -> View_transitions.element

val persist_element : string -> View_transitions.element
val astro_handler : Handler.config -> Handler.request_info -> Handler.response
...
val generate_types
  ...
  -> collections:Content.collection list
  -> string

val generate_routes : routes:Route_def.t list -> string
val generate_config : integrations:Integration.t list -> output:Handler.output -> string
