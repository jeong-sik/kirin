type request_id = int
type request = { id : request_id; method_ : string; params : Yojson.Safe.t; }
type success_response = { success_id : request_id; result : Yojson.Safe.t; }
type error_detail = {
  code : int;
  message : string;
...
type response = RpcSuccess of success_response | RpcError of failure_response
val parse_error : int
...
val render_request :
  url:string ->
  ?props:Yojson.Safe.t -> ?signals:Yojson.Safe.t -> unit -> request
val health_request : unit -> request
val shutdown_request : unit -> request
val encode_request : request -> string
val encode_error_detail :
  error_detail -> [> `Assoc of (string * Yojson.Safe.t) list ]
...
val response_to_json :
  response -> [> `Assoc of (string * Yojson.Safe.t) list ]
