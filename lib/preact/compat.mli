...
type alias = { from : string; to_ : string; }
...
type compat_level = Full | Partial | Aliased | Manual
type library_compat = {
  name : string;
  level : compat_level;
  notes : string option;
...
val config_to_json :
  config -> [> `Assoc of (string * [> `Bool of bool ]) list ]
val alias_to_json :
  alias -> [> `Assoc of (string * [> `String of string ]) list ]
