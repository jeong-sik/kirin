...
val with_manifest : config -> (Manifest.t -> ('a, string) result) -> ('a, string) result
val production_html : config -> entry:string -> title:string -> (string, string) result
val development_html : config -> entry:string -> title:string -> (string, 'a) result
