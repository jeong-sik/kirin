type 'a state = Active of 'a | Completed | Error of string
type message =
...
val encode_message :
  ...
  message ->
  [> `Assoc of
       (string * [> `Assoc of (string * Yojson.Safe.t) list | `String of 'a ])
       list ]
type request = { id : sub_id; method_ : string; params : Yojson.Safe.t; }
val parse_request :
  [> `Assoc of (string * Yojson.Safe.t) list ] -> request option
module Registry :
  sig
...
module WsMessage :
  sig
    ...
    val encode :
      ...
      [> `Assoc of
           (string *
            [> `Assoc of (string * Yojson.Safe.t) list | `String of sub_id ])
           list ]
  end
