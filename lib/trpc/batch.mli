type call = { id : int; path : string; input : Yojson.Safe.t; }
val parse_call : [> `Assoc of (string * Yojson.Safe.t) list ] -> call option
type response = { id : int; result : (Yojson.Safe.t, error) result; }
and error = { code : int; message : string; data : Yojson.Safe.t option; }
module ErrorCode :
  sig
    val parse_error : int
