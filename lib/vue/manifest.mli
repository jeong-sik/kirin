...
type plugin_entry = { name : string; src : string; mode : string; }
type t = {
...
val create_route :
  ...
  ?redirect:string option ->
  ?alias:string list ->
  ?is_page:bool -> ?is_layout:bool -> unit -> route_entry
val create_layout :
  name:string -> component:string -> ?is_default:bool -> unit -> layout_entry
val create_server_route :
  path:string ->
  handler:string -> ?method_:string -> unit -> server_route_entry
...
val server_route_to_json :
  server_route_entry -> [> `Assoc of (string * [> `String of string ]) list ]
val plugin_to_json :
  plugin_entry -> [> `Assoc of (string * [> `String of string ]) list ]
val to_json :
  t ->
  [> `Assoc of
       (string *
...
val from_discovered_routes :
  File_router.discovered_route list -> t
