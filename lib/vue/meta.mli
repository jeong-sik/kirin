...
val with_link :
  rel:string -> href:string -> ?type_:string -> ?sizes:string -> head -> head
...
val seo :
  title:string ->
  ?description:string -> ?image:string -> ?url:string -> unit -> seo_meta
...
val meta_to_json :
  meta -> [> `Assoc of (string * [> `String of string ]) list ]
val head_to_json :
  head ->
  [> `Assoc of
       (string *
       ...
       list ]
val seo_to_json :
  seo_meta -> [> `Assoc of (string * [> `String of string ]) list ]
