...
val create_context :
  ...
  ?cookies:(string * string) list ->
  ?body:Yojson.Safe.t ->
  ?route_name:string -> ?is_server:bool -> unit -> context
...
type cache_entry = { value : Yojson.Safe.t; timestamp : float; ttl : int; }
...
val context_to_json :
  ...
  [> `Assoc of
       ...
       list ]
val result_to_json :
  load_result -> [> `Assoc of (string * Yojson.Safe.t) list ]
