...
val spa_config : manifest_path:string -> entry_point:string -> unit -> Handler.config
...
val page
  :  path:string
  -> ?layout:string
  -> ?middleware:Route_def.middleware list
  -> unit
  -> Route_def.t
...
val dynamic
  :  path:string
  -> param_name:string
  -> ?param_type:Route_def.param_type
  -> unit
  -> Route_def.t
...
val fetch
  ...
  -> unit
  -> Loader.fetch_options

val async_data : key:string -> ?server:bool -> ?lazy_:bool -> unit -> Loader.async_options
...
val discover_routes : pages_dir:string -> unit -> File_router.discovered_route list
val manifest_from_routes : File_router.discovered_route list -> Manifest.t
