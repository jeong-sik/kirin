...
module LoadingStates :
  sig
    ...
    val with_spinner :
      class_:string -> delay_ms:int -> (string * string) list
  end
module ClassTools :
  sig
    val enable : string * string
...
module JsonEnc : sig val enable : string * string end
module PathDeps :
  sig
    val enable : string * string
    val path_deps : string list -> string * string
  end
module Restored : sig val enable : string * string end
module MultiSwap : sig val enable : string * string end
module Morphdom : sig val enable : string * string end
module AlpineMorph : sig val enable : string * string end
module Debug : sig val enable : string * string end
