...
val shell_with_placeholder
  :  head:string
  -> body_start:string
  -> suspense_fallbacks:string list
  -> string
...
val sse_stream : engine:Ssr.t -> url:string -> ?props:Yojson.Safe.t -> unit -> string
...
val error_boundary_fallback : boundary_id:string -> error_message:string -> string
