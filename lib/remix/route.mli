...
val create :
  ...
  ?action:(Action.action_context ->
           Yojson.Safe.t Action.action_result)
          option ->
  ?error_boundary:bool -> ?index:bool -> ?children:t list -> string -> t
val index :
  ?loader:(Loader.loader_context ->
           Yojson.Safe.t Loader.loader_result)
          option ->
...
val find_matches :
  t list -> string list -> match_result list -> match_result list
val execute_loader :
  t ->
  Loader.loader_context ->
  Yojson.Safe.t Loader.loader_result
...
val segment_to_json :
  segment -> [> `Assoc of (string * [> `String of string ]) list ]
val to_json :
  t ->
  ([> `Assoc of
