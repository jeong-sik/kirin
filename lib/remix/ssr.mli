...
val render_document : config:ssr_config -> context:render_context -> body:string -> string
...
val render_streaming
  :  config:'a
  -> context:'b
  -> render_shell:('b -> string)
  -> on_chunk:(stream_chunk -> unit)
  -> unit
...
val context_to_json : render_context -> [> `Assoc of (string * Yojson.Safe.t) list ]
