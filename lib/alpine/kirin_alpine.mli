...
val on : ?modifiers:Directive.modifier list -> string -> string -> Directive.t
val text : string -> Directive.t
val html : string -> Directive.t
val model : string -> Directive.t
val for_ : item:string -> ?index:string -> items:string -> unit -> Directive.t
...
val object_prop : ?default:(string * Yojson.Safe.t) list -> string -> Component.property
...
val render_page : config:Ssr.ssr_config -> state:Ssr.ssr_state -> body:string -> string
...
val handler
  ...
  -> render_body:('a -> Ssr.ssr_state -> string)
  -> 'a
  -> Kirin.Response.t
