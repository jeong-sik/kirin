...
val extract_params :
  string -> (string * Route_def.param_type) list
...
val discover_routes_aux :
  base_dir:string -> prefix:string -> string -> discovered_route list
...
val insert_route :
  string list -> discovered_route -> route_node -> route_node
val build_tree : discovered_route list -> route_node
val segment_to_json :
  segment -> [> `Assoc of (string * [> `Null | `String of string ]) list ]
