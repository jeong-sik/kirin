...
val create_hydration_context : ?mode:Hydration.hydration_mode -> unit -> Hydration.context
val hydration_boundary : id:string -> ?trigger:Hydration.trigger -> string -> string
...
val angular_handler : Handler.config -> Handler.request_info -> Handler.response
...
val generate_server_routes : routes:Route_def.t list -> string
val discover_routes : app_dir:string -> unit -> File_router.discovered_route list
