...
val int :
  ...
  ?exclusive_minimum:'a ->
  ?exclusive_maximum:'a ->
  unit -> [> `Assoc of (string * [> `Int of 'a | `String of string ]) list ]
val number :
  ?description:string ->
  ?minimum:'a ->
  ?maximum:'a ->
...
val bool :
  ?description:string ->
  unit -> [> `Assoc of (string * [> `String of string ]) list ]
...
val one_of :
  ?description:'a ->
  'b -> [> `Assoc of (string * [> `List of 'b | `String of 'a ]) list ]
val any_of :
  ?description:'a ->
  'b -> [> `Assoc of (string * [> `List of 'b | `String of 'a ]) list ]
val all_of :
...
val bool_with_default :
  default:'a ->
  ?description:string ->
  unit -> [> `Assoc of (string * [> `Bool of 'a | `String of string ]) list ]
val default_dialect : string
val with_dialect :
  ([> `Assoc of (string * [> `String of string ]) list ] as 'a) -> 'a
