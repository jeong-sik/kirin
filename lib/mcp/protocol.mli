...
val icon_to_json : icon -> [> `Assoc of (string * [> `String of string ]) list ]
...
val server_capabilities_to_json
  :  server_capabilities
  -> [> `Assoc of (string * [> `Assoc of (string * [> `Bool of bool ]) list ]) list ]
...
val tool_result_to_json : tool_result -> [> `Assoc of (string * Yojson.Safe.t) list ]
