...
val read_resource : t -> uri:string -> (Protocol.resource_contents, string) result
...
val handle_request : t -> ctx:eio_ctx -> Jsonrpc.request -> Jsonrpc.response
val handle_notification : t -> Jsonrpc.notification -> unit
val handle_message : t -> ctx:eio_ctx -> Jsonrpc.message -> Jsonrpc.message option
