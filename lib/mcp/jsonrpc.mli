...
val encode_notification :
  notification -> [> `Assoc of (string * Yojson.Safe.t) list ]
...
val make_request :
  id:id -> method_:string -> ?params:Yojson.Safe.t -> unit -> request
val make_response :
  id:id -> ?result:Yojson.Safe.t -> ?error:error -> unit -> response
val make_notification :
  method_:string -> ?params:Yojson.Safe.t -> unit -> notification
val make_error :
  code:error_code -> message:string -> ?data:Yojson.Safe.t -> unit -> error
