...
val write_message_stdio : Eio.Buf_write.t -> Jsonrpc.message -> unit
val create_streamable_http : ?endpoint:string -> unit -> t
val queue_message : t -> Jsonrpc.message -> unit
val read_message_streamable_http : streamable_http_transport -> Jsonrpc.message

val register_pending_request
  :  streamable_http_transport
  -> Jsonrpc.id
  -> Jsonrpc.response Eio.Promise.u
  -> unit
...
val send_http_request : streamable_http_transport -> Jsonrpc.request -> Jsonrpc.response
val send_request : t -> Jsonrpc.request -> Jsonrpc.response
