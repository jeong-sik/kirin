...
val create_context :
  ...
  ?platform:Yojson.Safe.t -> ?locals:Yojson.Safe.t -> unit -> load_context
...
type depends_on = Url | Param of string | Custom of string
...
type stream_chunk =
  ...
  | StreamComplete
val streaming :
  Yojson.Safe.t -> (string * Yojson.Safe.t) list -> stream_chunk list
val output_to_json :
  load_output -> [> `Assoc of (string * Yojson.Safe.t) list ]
val context_to_json :
  load_context ->
  [> `Assoc of
       (string *
