...
val page
  :  path:string
  -> loader:(url:string -> params:(string * string) list -> Route_def.load_result)
  -> Route_def.t
...
val page_with_actions
  ...
  -> loader:(url:string -> params:(string * string) list -> Route_def.load_result)
  -> actions:
       (string * (url:string -> form_data:Yojson.Safe.t -> Route_def.action_result)) list
  -> Route_def.t
...
val preload_link : href:string -> ?strategy:[< `Hover | `Off | `Tap ] -> string -> string
