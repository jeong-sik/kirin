type preload_strategy = Hover | Tap | Viewport | Eager | Off
type preload_type = Code | Data | CodeAndData
type nav_behavior = Navigate | NoScroll | KeepFocus | ReplaceState
...
val route_hints :
  js:string list ->
  css:string list -> ?prefetch:string list -> unit -> route_hints
