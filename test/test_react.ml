...
let manifest_tests =
  ...
  ; ( "resolve file path"
    ...
    , fun () ->
        let json =
          `Assoc [ "src/main.tsx", `Assoc [ "file", `String "assets/main-xyz789.js" ] ]
        in
        let manifest = Manifest.parse json in
  ...
  ; ( "description tag"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "description") tag 0 in
             true
           with
           | Not_found -> false) )
  ; ( "og tag"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "og:title") tag 0 in
             true
           with
           | Not_found -> false) )
  ; ( "twitter tag"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "twitter:card") tag 0 in
             true
           with
           | Not_found -> false) )
  ; ( "canonical link"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "canonical") tag 0 in
             true
           with
           | Not_found -> false) )
  ; ( "escape html"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          (not
             (try
                let _ = Str.search_forward (Str.regexp_string "<script>") tag 0 in
                true
              with
              | Not_found -> false)) )
  ]
...
let assets_tests =
  [ ( "url resolution"
    ...
    , fun () ->
        let json =
          `Assoc [ "main.tsx", `Assoc [ "file", `String "assets/main-abc.js" ] ]
        in
        let manifest = Manifest.parse json in
  ...
  ; ( "script_tag generation"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "module") tag 0 in
             true
           with
           | Not_found -> false) )
  ; ( "link_tag generation"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "stylesheet") tag 0 in
             true
           with
           | Not_found -> false) )
  ; ( "css_tags multiple"
  ...
  ; ( "dev_server_url"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "localhost") url 0 in
             true
           with
           | Not_found -> false);
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "5173") url 0 in
             true
           with
           | Not_found -> false) )
  ; ( "dev_script_tag"
  ...
  ; ( "hmr_script"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "@vite/client") tag 0 in
             true
           with
           | Not_found -> false) )
  ]
  ...
  ; ( "xss escape"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          (not
             (try
                let _ = Str.search_forward (Str.regexp_string "</script>") s 0 in
                true
              with
              | Not_found -> false)) )
  ; ( "script_tag generation"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          (try
             let _ =
               Str.search_forward (Str.regexp_string "window.__INITIAL_DATA__") tag 0
             in
             true
           with
           | Not_found -> false) )
  ; ( "named_script_tag"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "__MY_DATA__") tag 0 in
             true
           with
           | Not_found -> false) )
  ]
  ...
  [ ( "render default options"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "<!DOCTYPE html>") html 0 in
             true
           with
           | Not_found -> false);
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string {|id="root"|}) html 0 in
             true
           with
           | Not_found -> false) )
  ; ( "render with title"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          (try
             let _ =
               Str.search_forward (Str.regexp_string "<title>My App</title>") html 0
             in
             true
           with
           | Not_found -> false) )
  ; ( "render with initial_data"
    , `Quick
    , fun () ->
        let opts =
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "__INITIAL_DATA__") html 0 in
             true
           with
           | Not_found -> false) )
  ; ( "render with scripts"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "/app.js") html 0 in
             true
           with
           | Not_found -> false) )
  ; ( "render with styles"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "/style.css") html 0 in
             true
           with
           | Not_found -> false) )
  ; ( "custom root_id"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string {|id="app"|}) html 0 in
             true
           with
           | Not_found -> false) )
  ; ( "builder pattern"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "Builder Test") html 0 in
             true
           with
           | Not_found -> false) )
  ; ( "shell convenience"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "<!DOCTYPE") html 0 in
             true
           with
           | Not_found -> false) )
  ]
...
let protocol_tests =
  [ ( "encode request"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "jsonrpc") s 0 in
             true
           with
           | Not_found -> false);
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "render") s 0 in
             true
           with
           | Not_found -> false) )
  ; ( "decode success response"
    ...
    , fun () ->
        ...
        | Ok (Protocol.Success { id; _ }) -> Alcotest.(check int) "id" 1 id
  ...
  ; ( "extract html"
    ...
    , fun () ->
        let response =
          Protocol.Success
            { id = 1; result = `Assoc [ "html", `String "<div>Hello</div>" ] }
        in
...
let worker_tests =
  ...
  ; ( "render cache set/get"
    , `Quick
    , fun () ->
        let cache = Worker.Render_cache.create () in
        Worker.Render_cache.set
          cache
          ~url:"/test"
          ~props:(`Assoc [])
          ~html:"<div>cached</div>"
  ...
  ; ( "sse event format"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "event: test") event 0 in
             true
           with
           | Not_found -> false);
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "data: hello") event 0 in
             true
           with
           | Not_found -> false) )
  ; ( "sse complete"
    ...
    , fun () ->
        ...
        Alcotest.(check bool)
          ...
          true
          (try
             let _ = Str.search_forward (Str.regexp_string "complete") event 0 in
             true
           with
           | Not_found -> false) )
  ]
