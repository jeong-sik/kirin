...
let basic_tests =
  ...
  ; ( "add translations"
    ...
    , fun () ->
        let i18n =
          I18n.create ()
          |> I18n.add_translations "en" [ "greeting", "Hello"; "farewell", "Goodbye" ]
        in
  ...
  ; ( "available locales"
    ...
    , fun () ->
        let i18n =
          ...
          |> I18n.add_translations "ko" [ "greeting", "안녕하세요" ]
        in
...
let translation_tests =
  [ ( "simple translation"
    , `Quick
    , fun () ->
        let i18n = I18n.create () |> I18n.add_translations "en" [ "greeting", "Hello" ] in
  ...
  ; ( "translation with interpolation"
    ...
    , fun () ->
        let i18n =
          I18n.create () |> I18n.add_translations "en" [ "greeting", "Hello, {{name}}!" ]
        in
  ...
  ; ( "multiple interpolations"
    ...
    , fun () ->
        let i18n =
          I18n.create ()
          |> I18n.add_translations "en" [ "message", "{{user}} sent {{count}} messages" ]
        in
        let msg =
          I18n.translate
            i18n
            ~locale:"en"
            ~args:[ "user", "Alice"; "count", "5" ]
            "message"
        in
  ...
  ; ( "korean translation"
    ...
    , fun () ->
        let i18n =
          I18n.create () |> I18n.add_translations "ko" [ "greeting", "안녕하세요, {{name}}님!" ]
        in
...
let translator_tests =
  [ ( "translator for header"
    , `Quick
    , fun () ->
        let i18n =
          I18n.create ()
          |> I18n.add_translations "en" [ "greeting", "Hello, {{name}}!" ]
          |> I18n.add_translations "ko" [ "greeting", "안녕하세요, {{name}}님!" ]
        in
...
let locale_management_tests =
  [ ( "set locale"
    ...
    , fun () ->
        let i18n =
          I18n.create () |> I18n.add_translations "en" [] |> I18n.add_translations "ko" []
        in
  ...
  ; ( "set fallback"
    ...
    , fun () ->
        let i18n =
          ...
          |> I18n.set_fallback ~locale:"en-US" ~fallback:"en"
        in
