...
let test_loader () =
  ...
  test "param from context" (fun () ->
    let ctx : _ Route_def.loader_context =
      { ctx = (); params = [ "id", "123" ]; search_params = [] }
    in
  ...
  test "param_int valid" (fun () ->
    let ctx : _ Route_def.loader_context =
      { ctx = (); params = [ "page", "42" ]; search_params = [] }
    in
  ...
  test "search_param" (fun () ->
    let ctx : _ Route_def.loader_context =
      { ctx = (); params = []; search_params = [ "q", "test" ] }
    in
...
let test_action () =
  ...
  test "param from context" (fun () ->
    let ctx : _ Route_def.action_context =
      { ctx = (); params = [ "id", "456" ]; method_ = Route_def.POST; body = None }
    in
  ...
  test "json_body" (fun () ->
    let ctx : _ Route_def.action_context =
      { ctx = (); params = []; method_ = Route_def.POST; body = Some (`String "test") }
    in
  ...
  test "for_method matches" (fun () ->
    ...
    let ctx : _ Route_def.action_context =
      { ctx = (); params = [ "id", "123" ]; method_ = Route_def.POST; body = None }
    in
  ...
  test "for_method rejects" (fun () ->
    ...
    let post_action = Action.post_only action in
    let ctx : _ Route_def.action_context =
      { ctx = (); params = []; method_ = Route_def.GET; body = None }
    in
    match post_action ctx with
