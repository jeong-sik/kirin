...
(* ============================================================
   Database Tests (Phase 12) - Query Builder Unit Tests
   ============================================================ *)
...
(* ============================================================
   Migration Tests (Phase 12) - Type and Helper Tests
   ============================================================ *)
...
let test_migrate_pp_result_success () =
  ...
  (* UTF-8 checkmark is 3 bytes, so check if string contains it *)
  check bool "has checkmark" true (String.sub s 0 3 = "✓")
...
(* ============================================================
   Database Tests (Phase 12) - Db Module Type Tests
   ============================================================ *)
